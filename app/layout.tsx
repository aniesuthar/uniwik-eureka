...
})(window,document,'script','dataLayer','GTM-NTPGP2LP');`,
          }}
        />
...
fbq('track', 'PageView');`,
        ...
        <noscript>
          ...
          <img
            ...
            width="1"
            style={{ display: "none" }}
            src="https://www.facebook.com/tr?id=3334193270089179&ev=PageView&noscript=1"
            alt=""
          />
        </noscript>
        {/* End Meta Pixel Code */}
      ...
      <body className="min-h-full flex flex-col bg-white text-slate-900 selection:bg-[#0084ff] selection:text-white font-sans">
        ...
        <noscript>
          <iframe
            src="https://www.googletagmanager.com/ns.html?id=GTM-NTPGP2LP"
            height="0"
            width="0"
